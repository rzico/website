<template>
<div class="weui-cell" :class="{'weui-vcode': vcode, 'weui-cell-warn': warn}">
  ...
  <cell-body>
    ...
    <div class="weui-textarea-counter" v-if="type === 'textarea' && maxlength"><span>{{value.length}}/{{maxlength}}</span></div>
  </cell-body>
