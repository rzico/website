...
<script>
  ...
  import article_cover from './article/t1032/cover.vue';
  import music from './article/music.vue';
  import article_content from './article/t1032/content.vue';
