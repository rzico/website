  ...
  <div class="mp-content">
    <div  v-for="(template,index) in templatesList" >
      <div class="margin-section section section-on section-border text-up fill" v-if="isShow(index)">
        ...
        <!--判断类型是图文还是小视频-->
        <div class="img-box padding_left offline-preview " v-if="hasImage(template,index) && index%2 != 0"   >
          <div class="xiushi-1"></div>
          <div class="xiushi-2"></div>
          <div class="xiushi-3"></div>
          <div class="xiushi-4"></div>
          <div class="bian1 guo-l"></div>
          <div class="bian1 guo-r"></div>
          <div class="bian3 five-stars"></div>
          <img
        ...
        <div class="img-box padding_right offline-preview " v-if="hasImage(template,index) && index%2 != 0"   >
          <div class="xiushi-1"></div>
          <div class="xiushi-2"></div>
          <div class="xiushi-3"></div>
          <div class="xiushi-4"></div>
          <div class="bian1 dang-top"></div>
          <div class="bian1 dang-bottom"></div>
          <div class="bian3"></div>
          <img
            v-lazy="template.original "
            class="images shadow img-border preview-img"@click="imgPreview(template.original,templatesList.previewList)" ref="imgRef"/>
