  ...
  <div class="mp-content">
    <div  v-for="(template,index) in templatesList" >
      <div class="margin-section section section-on section-border text-up fill" >
        ...
        <!--判断类型是图文还是小视频-->
        <div class="img-box" v-if="hasImage(template,index) "  :class="[index%2 == 0 ? 'xiushi1' : 'xiushi2']"  >
          <div class="crab crab-small" v-if="index%2 == 0"></div>
          <div class="crab crab-big" v-else></div>
          <div class="ye2 leafbottom" v-if="index%2 == 1"></div>
          <div class="ye1 leaftop" v-if="index%2 == 1"></div>
          <img
