...
<style>
  ...
  .t1008 .auther .autherwrap a .autherHead {
    height: 86px;
    width: 86px;
    position: absolute;
    top: 0;
  ...
  .t1008 .auther .autherwrap a .userMessage {
    padding-top: 19px;
    float: left;
    width: 100%;
    line-height: 1.6;
  }
  .t1008 .auther .autherwrap a .qrcode {
    width: 200px;height: 200px;margin-top: 19px;margin-bottom: 19px;
  }

  .t1008 .auther .autherwrap a .right {
    height: 100%;
    width: 42px;
    position: absolute;
    top: 0;
  ...
  .t1008 .auther .autherwrap a .autherHead img {
    display: block;
    position: absolute;
    top: 0;
    left: 0;
  ...
  .t1008 .auther .autherwrap a .userMessage .wusername {
    font-size: 16px;
    color: #DADBB8;
    white-space: nowrap;
    text-overflow: ellipsis;
  }
  .t1008 .auther .autherwrap a .userMessage .wsign {
    font-size: 14px;
    color: #A2A580;
    white-space: nowrap;
    text-overflow: ellipsis;
