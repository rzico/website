...
<style>
  ...
  .seasons .review .list .item:last-child {
    border-bottom: 0px;
  }

  .seasons .review .list .item .logo {
    float: left;
  ...
  .seasons .review .list .item .content {
    overflow: hidden;
  }

  .seasons .review .list .item .content .name {
    margin-top: 11px;
    font-size: 16px;
    line-height: 16px;
    color:#57bdec;
  ...
  .seasons .review .list .item .content p {
    margin-top: 0;
    font-size: 16px;
    color: #DADBB8;
    overflow: hidden;
  ...
  .seasons .review .list .item .content .time {
    margin-top: 11px;
    font-size: 12px;
    line-height: 16px;
    color: #A2A580;
