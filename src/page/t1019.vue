...
<style>
  @import "../less/t1019.less";
  .t1019 .foot-bg{
    background: #005F41 url(data:image/jpeg;base64,/9j/4QAYRXhpZgAASUkqAAgAAAAAAAAAAAAAAP/sABFEdWNreQAB…AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAB//Z) repeat-y;
  }
</style>
...
<script>
  ...
  import article_cover from './article/t1019/cover.vue';
